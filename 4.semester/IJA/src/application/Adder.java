 ...
 */
package application;
public class Adder extends ArithmBlock{

    /**
     * Constructor of Adder block, calls super constructor
     */
    public Adder() {
    	super("adder");
    }
    ...
    /**
     * Function adds up two complex numbers and writes the result to output port 
     */
    public void Execute() {
