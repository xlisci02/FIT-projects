...
int main(int argc, char **argv)
{
  ...
  struct Particles particles(N); // allocation is part of the constructor
  struct Velocities velocities(N); // allocation is part of the constructor
