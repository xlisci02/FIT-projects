...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			<li class="active" ><a href="show_vets.php">Vets</a></li>
	...
	<div class="modal-dialog">
	  ...
	  <div class="modal-content">
		<div class="modal-header">
		  ...
		  <h4 class="modal-title">Edit vet</h4>
		</div>
		<div class="modal-body wrapper ">
			<form action="edit_user.php" method="post">
				...
				<div class="form-group">
					<input type="hidden" name="user" value="vet">						
...
<div class="container">
	...
	<div class="modal fade" id="Delete" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Delete vet</h4>
				</div>
	...
	<div class="container-fluid">
		<a href="add_user.php" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-plus"> </span> Add vet</a>
